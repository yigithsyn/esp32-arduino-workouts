...
//static BLEUUID serviceUUID("00002A-0000-1000-8000-00805F9B34FB");
...
bool connectToServer() {
    ...
    for ( it = pRemoteCharacteristics->begin(); it != pRemoteCharacteristics->end(); it++ )
    {
